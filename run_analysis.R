...
##3.Extract only mean and standard diviation
...
##Write the tidy table out to text file
write.table(dtTidy, file="output_tidy_file.txt", quote=FALSE, sep="\t", row.names=FALSE)
